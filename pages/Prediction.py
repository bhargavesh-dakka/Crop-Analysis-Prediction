...
temperature = st.sidebar.number_input("Temperature",min_value=0.0,step=10.0)
humidity = st.sidebar.number_input("Humidity",min_value=0.0,step=10.0)
ph = st.sidebar.number_input("PH",min_value=0.0,step=10.0)
rainfall = st.sidebar.number_input("Rainfall",min_value=0.0,step=10.0)
